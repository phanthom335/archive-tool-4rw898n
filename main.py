    """
    Archive Tool 4rw898n
    ====================
    Lightweight terminal utility built to inspect your filesystem and configurations.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight terminal utility built to inspect your filesystem and configurations.")
